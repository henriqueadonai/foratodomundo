...
class App extends Component {
  ...
  constructor(props){
    ...
    this.state.presidentes = [
      ...
      {id:5, nome:'Fernando Henrique' , foto:'https://upload.wikimedia.org/wikipedia/commons/c/cf/Fernando_Henrique_Cardoso_%281994%29.jpg',mandato:'1994-2002'},
    ...
    this.state.eleicoesPres = [
      {id:1, turno:'Primeiro',  date:'October 2 2018 12:00 AM GMT-0300'},
      {id:2, turno:'Segundo', date:'October 30 2018 12:00 AM GMT-0300'}
    ]
}
  ...
  render() {
   ...
   <Router >
        ...
        <header className="bg-white black-80 tc pv4 avenir">
          ...
          <h2 className="mt2 mb0 f6 fw4 ttu tracked">Tempo de mudança e oportunidades</h2>
            ...
            <nav className="bt bb tc mw7 center mt4">
              ...
              <Link className="f6 f5-l link bg-animate black-80 hover-bg-lightest-blue dib pa3 ph4-l" to={'/presidentes'}>Presidentes </Link>
        ...
        <Route exact={true} path='/presidentes' render={() => (
